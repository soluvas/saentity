...
public class SaentityInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	public Injector getInjector() {
		if (injector == null) {
			this.injector = new SaentityStandaloneSetup().createInjectorAndDoEMFRegistration();
		}
		return injector;
	}
