...
import com.soluvas.saentity.saentity.SaentityFactory;
 ...
 * @generated
 */
public class SaentityPackageImpl extends EPackageImpl implements SaentityPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.soluvas.saentity.saentity.SaentityPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private SaentityPackageImpl()
  {
    super(eNS_URI, SaentityFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link SaentityPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static SaentityPackage init()
  {
    if (isInited) return (SaentityPackage)EPackage.Registry.INSTANCE.getEPackage(SaentityPackage.eNS_URI);

    // Obtain or create and register package
    SaentityPackageImpl theSaentityPackage = (SaentityPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SaentityPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SaentityPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theSaentityPackage.createPackageContents();

    // Initialize created meta-data
    theSaentityPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theSaentityPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(SaentityPackage.eNS_URI, theSaentityPackage);
    return theSaentityPackage;
  }
   ...
   * @generated
   */
  public EAttribute getAttribute_DataClass()
  {
   ...
   * @generated
   */
  public SaentityFactory getSaentityFactory()
  {
    return (SaentityFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(attributeEClass, ATTRIBUTE__DATA_CLASS);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getEntity_Labels(), this.getLabel(), null, "labels", null, 0, -1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAttribute_DataClass(), ecorePackage.getEString(), "dataClass", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
